...
groupDetailsSchema.methods = {
  ...
  removeMembers: async function(members){
    ...
    console.log("removing group members 1 : ", members)
    if(members instanceof Array && members.length > 0){
      
      const memberIdsToRemove = members.map(v=>strToId(v))
      ...
      console.log("removing members : ", memberIdsToRemove, this.members, this.members.filter(predicate))
