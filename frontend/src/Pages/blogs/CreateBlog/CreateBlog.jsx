...
const CreateBlog = () => {
  ...
  const createBlogHandler = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        goto("/user/blogs/userBlogs")
      } else {
        alert(`Error: ${result.error || "Unable to create blog"}`);
      }
    } catch (error) {
  ...
  const submitButtonText = isSubmitting ? "Publishing..." : "Publish"

  return (
    <div className="create-blog-container">
      <form onSubmit={createBlogHandler} className="blog-form">
        <input
          type="text"
        ...
        <div className="editor-toolbar">
          ...
          <button type="button" onClick={() => formatText("foreColor", "red")} title="Red Text" className="red-text">
            <span style={{ color: "red" }}>A</span>
          </button>
          <button type="button" onClick={() => formatText("foreColor", "blue")} title="Blue Text" className="blue-text">
            <span style={{ color: "blue" }}>A</span>
          </button>
          <button type="button" onClick={() => formatText("foreColor", "black")} title="Black Text" className="black-text">
