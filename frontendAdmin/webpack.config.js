...
const CSSInjectPlugin = require('../frontend/react_lite/cssInjectPlugin');
        ...
        rules: [
            {
                ...
                use: [
                    ...
                    // },
                    {
                        loader: path.resolve(__dirname, "../frontend/react_lite/transpile.js")
                    }
                ]
            },
            {
                ...
                use: [
                    {
                        loader: path.resolve(__dirname, "../frontend/react_lite/cssLoader.js")
                    }
                ]
            },
            {
