        ...
        <div className="landing-page">
            ...
            <div className="hero cont">
                <div className="box">
                    <div className="left">
                        {/* <h1>LEARNET</h1> */}
                        <h2><span>Empowering Collaborative Learning</span><br /><span>Anytime, Anywhere.</span></h2>
                        <p>Explore, create, and share knowledge</p>
                        {/* <p>with a global network of learners. Start Your Journey</p> */}
                        <Link className="icon-button" to="/signup" label="Get started" />
                    </div>
                    <div className="right">
