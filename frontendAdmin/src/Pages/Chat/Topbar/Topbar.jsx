...
const Topbar = () => {
    ...
    return ( 
        <div className="chat-topbar">
            <div className="left">
                <button className={activeLeft === "all" ? "icon-button active" : "icon-button"} onClick={()=>setActiveLeft("all")}>All</button>
                <button className={activeLeft === "unread" ? "icon-button active" : "icon-button"} onClick={()=>setActiveLeft("unread")}>Unread</button>
                <button className={activeLeft === "favourits" ? "icon-button active" : "icon-button"} onClick={()=>setActiveLeft("favourits")}>Favourits</button>
                <button className={activeLeft === "groups" ? "icon-button active" : "icon-button"} onClick={()=>setActiveLeft("groups")}>Groups</button>
            </div>
            <div className="right">
