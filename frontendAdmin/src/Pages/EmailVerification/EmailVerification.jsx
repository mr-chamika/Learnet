                ...
                <div className="box">
                    <div className="form">
                        ...
                        <div className="message">
                            ...
                            <button disabled={resenButtonDisabled} className="icon-button" onClick={resendOtpHandler}>Resend OTP</button>
                        </div>
                        <OTPExpirationTimer timeLeft={timeLeft} setTimeLeft={setTimeLeft} duration="60" />
                    </div>
                </div>
            </div>
        </div>
